...
type
  ...
  public
    ...
    function LocalTimeToGMT(const ADateTime: TTZDateTime; const AFromZone: String): TTZDateTime; overload;
    function LocalTimeToGMT(const ADateTime: TDateTime; const AFromZone: String): TDateTime; overload;
...
begin
  ...
  try
    ...
    // In month...
    TmpWord := AIterator.GetNextWord;
    NewRule.InMonth := MonthNumberFromShortName(Copy(TmpWord,1,3));
  ...
  try
    ...
    begin
      ...
      try
        ...
        ADataStream.WriteString(sLineBreak  + sLineBreak);
      finally
        AFileStream.Free;
      end;
    end;
